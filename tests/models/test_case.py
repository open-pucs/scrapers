...
class TestCaseModel(unittest.TestCase):
    def test_valid_case(self):
        ...
        self.assertEqual(case.docket_govid, "12345")
    ...
    def test_missing_optional_fields(self):
        ...
        case = GenericCase(docket_govid="67890", opened_date=date(2023, 7, 1))
        self.assertEqual(case.docket_govid, "67890")
    ...
    def test_invalid_date_format(self):
        ...
        with self.assertRaises(ValidationError):
            GenericCase(docket_govid="12345", opened_date="not-a-date")
